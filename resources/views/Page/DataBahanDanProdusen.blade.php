    ...
    <div class="main-container">
        ...
        <div class="header-wrapper">
            <div class="container-btn">
                <a href="#" class="btn-header" data-bs-toggle="modal" data-bs-target="#modalSupplier">
                    Tambah Data Supplier
                </a>
                <a href="#" class="btn-header" data-bs-toggle="modal" data-bs-target="#modalBahan">
                    Tambah Data Bahan
                </a>
            </div>
        ...
        <section>
            ...
            @else
                <div class="card shadow-sm mb-4">
                    <div class="card-header text-white" style="background-color: #0A2568; border: 1px solid #ffffffff">
